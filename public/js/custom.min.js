...
$('.media-sec').find('.col-md-4').each(function(e){
    $(this).attr('data-eq',e);
})
$('.media-sec').find('.col-md-4').hover(function(f){
    var _integ=parseInt($(this).data('eq'))
    $("#carousel-example-generic").carousel(_integ);
})
...
$('a[href="#search"]').on('click', function(event) {
    ...
    $(".fb strong").click(function() {
      setTimeout(function() {
        $(this).attr("style","display:table");
      }, 1000);
  })
$('button[data-type="minus"]').click(function(){
let _val = $(this).parent('span').next('input').eq(0).val();
_val = parseInt(_val);
_val = _val-1;
if(_val>0){
  $(this).parent('span').next('input').eq(0).val(_val);
}
})
$('button[data-type="plus"]').click(function(){
let _val =$(this).parent('span').prev('input').eq(0).val();
_val = parseInt(_val);
_val = _val+1;
$(this).parent('span').prev('input').eq(0).val(_val);
})