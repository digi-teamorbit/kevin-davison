            ...
            <nav class="sidebar-nav ">
                <ul id="sidebarnav">
                    <li class="clearfix"></li>
                        ...
                        <li class=""><a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="flaticon-desktop-computer-screen-with-rising-graph"></i>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{url('admin/inner-banner')}}" class="">Inner Banner</a></li>
                  ...
                  <!--   <li><hr></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="fas fa-edit"></i>
                            <span class="hide-menu">Articles Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('admin/article-category')}}" class="">Categories</a></li>
                                <li><a href="{{url('admin/article')}}" class="">Articles</a></li>
                    ...
                    <li>
                        <a href="{{url('admin/asset-class')}}">
                            <i class="fas fa-building">
                                
                            </i><span class="hide-menu">Asset Class</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{url('admin/faq')}}">
                            ...
                            </i><span class="hide-menu">FAQ</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{url('admin/gallery')}}">
                            ...
                            </i><span class="hide-menu">Gallery</span>
                        </a>
                    </li>
                   ...
                   <!--      <li><hr></li>
                    ...
                    <li>
                        <a href="{{url('admin/article')}}">
                            ...
                            </i><span class="hide-menu">Articles</span>
                        </a>
                    </li> -->
