        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header"><a class="navbar-brand" href="{{url('/')}}">
                    ...
                    <b>
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{asset($logo->img_path)}}" style=" width: 100px; background-color: lightgrey;" alt="homepage" class="dark-logo"/>
						
                        <!-- Light Logo icon -->
                        <img src="{{asset($logo->img_path)}}" style=" width: 100px; background-color: lightgrey; " alt="homepage" class="light-logo"/> </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span>
          <!-- dark Logo text -->
