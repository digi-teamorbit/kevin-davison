    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Article</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/article/create') }}"><i
                                    class="icon-plus"></i> Add Article</a>
                    ...
                    <div class="table-responsive">
                        <table class="table color-table table-bordered product-table table-hover dataTable no-footer" role="grid" aria-describedby="myTable_info" id="myTable">
                            ...
                            <tr>
                                <th>#</th>
                                <th style="width: 50%;">Title</th><th>Image</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($article as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td><td class="text-center"><img src="{{asset($item->image)}}"></td>
