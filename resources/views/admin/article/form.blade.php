<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('category') ? 'has-error' : ''}}">
    <div class="col-md-12">
        ...
        {!! Form::select('item_id', $items, isset($article)?$article->category:null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<!-- iframe -->
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('map') ? 'has-error' : ''}}">
    {!! Form::label('map', 'Map', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
        {!! Form::textarea('map', null, ('required' == 'required') ? ['class' => 'form-control', 'id' => 'summary-ckeditor1', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('image') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        ...
        src="{{ isset($article)?asset($article->image):asset('images/upload.jpg') }}" style=" width: 30%; "> 
        <br/>
      </div>
        <br/>
