...
@section('content')
    ...
    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('logo_upload')}}">
    @csrf
        <div class="card">
          <div class="card-body">
           ...
           <div class="clearfix"></div>
            ...
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($logo)?asset($logo->img_path):asset('images/upload.jpg') }}" style="background-color: lightgrey; width: 100%;">
