        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="dashboard">
                    ...
                    <img alt="" style=" width: 200px; margin: 0px auto; display: flex; background-color: lightgrey; " class="img-responsive" id="blah1" src="{{ asset(!empty($logo->img_path)?$logo->img_path:'') }}">
                </div>
            </div>
            <!-- Column -->
        </div>
