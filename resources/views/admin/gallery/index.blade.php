    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Gallery</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/gallery/create') }}"><i
                                    class="icon-plus"></i> Add Image</a>
                            ...
                            @foreach($gallery as $item)
                                <tr>
                                    ...
                                    <td>
                                          ...
                                          <a href="{{ url('/admin/gallery/' . $item->id) }}"
                                               title="View Gallery">
