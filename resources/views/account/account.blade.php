...
$inner_banner14 = DB::table('inner_banners')->where('id', 14)->first(); 
      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"  data-interval="false" autoplay="false">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="{{asset($inner_banner14->image)}}" class="img-responsive" alt="...">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="book-ur-holiday inner-text-hd">
                      <?= html_entity_decode($inner_banner14->description) ?>
                    </div>
                  </div>
                </div>
              </div>
