...
//============================================================//
    ...
    Route::get('user/edit/{id}','Admin\\UsersController@edit')->name('user_edit');
    Route::post('user/edit/{id}','Admin\\UsersController@update');
    Route::get('user/delete/{id}','Admin\\UsersController@destroy')->name('user_delete');
...
Route::get('/data-sheets','HomeController@dataSheets')->name('data_sheets');
Route::get('/datasheets-one','HomeController@dataSheetsOne')->name('data_sheets_one');
Route::get('/log-In','HomeController@logIn')->name('log-In');
Route::get('/my-account','HomeController@myAccount')->name('my_account');
Route::get('/news-feed-detail/{article}','HomeController@newsFeedDetail')->name('news_feed_detail');
Route::get('/news-feed/{category}','HomeController@newsFeed')->name('news_feed');
Route::get('/payment-page','HomeController@payment')->name('payment');
...
Route::any('newsletter-submit','HomeController@newsletterSubmit')->name('newsletterSubmit');
...
Route::resource('admin/asset-class', 'Admin\\AssetClassController');
Route::resource('admin/feature', 'Admin\\FeatureController');